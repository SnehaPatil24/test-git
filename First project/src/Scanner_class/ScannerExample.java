...
public class ScannerExample {
	...
	public static void main(String[] args) {
		...
		// Scanner object is created and specific that we are using input stream to read
		// value from console
		...
		/*
		 * System.out.println("Please enter string value "); String var3=obj.next(); //
		 * Next method will only accept single word System.out.println(var3);
		 */
